...
const addNumbers = (num, arr, times, callback) => {
  const timesArr = new Array(times).fill(num);
  timesArr.forEach(() => {
    callback(num,arr);
  });
  return arr;
...
// la trampa es el orden del codigo ya que si la condicional del if no empieza con el requisito "If the number is divisible by both 3 and 5, add the phrase "Fizz Buzz" to the output array." que te pide... entonces se cumple las condiciones de 5 o 3 antes y no se imprime "FIZZ BUZZ" sino "Fizz" o "Buzz"
